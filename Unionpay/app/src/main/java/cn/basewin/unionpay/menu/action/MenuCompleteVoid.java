 ...
 * 描述: 预授权完成撤销<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_COMPLETE_VOID)
public class MenuCompleteVoid extends MenuAction {
    @Override
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(InputManagerPWDAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_COMPLETE_VOID);
            }
        };
    }
}

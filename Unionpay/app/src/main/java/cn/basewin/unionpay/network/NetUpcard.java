 ...
 * 描述: 手机芯片消费报文 <br>
 */
@AnnotationNet(action = ActionConstant.ACTION_UPCARD)
public class NetUpcard extends ReverseTradeMessage {
    private static final String TAG = NetUpcard.class.getName();

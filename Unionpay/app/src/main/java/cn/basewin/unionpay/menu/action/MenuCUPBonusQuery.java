 ...
 * 描述: 联盟积分查询<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_CUPBONUS_QUERY)
public class MenuCUPBonusQuery extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_CUPBONUS_QUERY));
    }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(SwipingCardAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_CUPBONUS_QUERY);
            }
        };
    }
}

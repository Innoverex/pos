 ...
 * 描述: 分期付款消费撤销<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_INSTALLMENT_VOID)
public class MenuInstallmentVoid extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_INSTALLMENT_VOID));
    }

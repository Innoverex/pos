 ...
 * 描述: 普通支付 <br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_EC_SALE)
public class MenuECSale extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_EC_SALE));
    }

    @Override
    public int getResIcon() {
        return R.drawable.ic_purchase_state;
    }
    ...
    public Runnable getRun() {
        return new Runnable() {
            ...
            public void run() {
                ...
                FlowControl.MapHelper.setSwipingType(InputPBOCInitData.USE_IC_CARD);
                flowControl.begin(InputMoneyAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_EC_SALE);
            }
        };
    }
}

 ...
 * 描述: 发卡行积分消费 <br>
 */
@AnnotationNet(action = ActionConstant.ACTION_BONUS)
public class NetBonus extends ReverseTradeMessage {
    private static final String TAG = NetBonus.class.getName();
    ...
    protected Iso8583Manager getEncryption(Map<String, Object> map, Iso8583Manager iso) throws Exception {
        ...
        iso.setBit(60, "22" + batchAuto + "000" + "5" + "0" + "1" + "" + "048");

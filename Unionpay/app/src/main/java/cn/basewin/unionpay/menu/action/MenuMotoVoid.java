 ...
 * 描述: 订购消费撤销 <br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_MOTO_VOID)
public class MenuMotoVoid extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_MOTO_VOID));
    }
...
//                        .next(InputPWDAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_MOTO_VOID);
            }
        };
    }
}

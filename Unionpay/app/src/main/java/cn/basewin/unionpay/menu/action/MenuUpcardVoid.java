 ...
 * 描述: 手机芯片消费撤销 <br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_UPCARD_VOID)
public class MenuUpcardVoid extends MenuAction {
    private static final String TAG = MenuUpcardVoid.class.getName();

    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_UPCARD_VOID));
    }

    @Override
    public int getResIcon() {
        return R.drawable.main_refund_state;
    }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(InputManagerPWDAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_INSTALLMENT_VOID);
            }
        };
    }
}

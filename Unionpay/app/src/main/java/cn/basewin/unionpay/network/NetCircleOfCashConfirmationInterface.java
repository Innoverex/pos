 ...
 * 现金圈提确认接口
 */
@AnnotationNet(action = ActionConstant.ACTION_CIRCLE_OF_CASH_CONFIRMATION_INTERFACE)
public class NetCircleOfCashConfirmationInterface extends ReverseTradeMessage {

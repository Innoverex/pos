...
import cn.basewin.unionpay.trade.InputGoodsCodeAty;
 ...
 * 描述: 联盟积分消费<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_CUPBONUS)
public class MenuCUPBonus extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_CUPBONUS));
    }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(InputMoneyAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_CUPBONUS);
            }
        };
    }
}

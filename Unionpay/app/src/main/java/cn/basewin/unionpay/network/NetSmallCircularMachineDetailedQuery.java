 ...
 * 小额循环机明细查询
 */
@AnnotationNet(action = ActionConstant.ACTION_SMALL_CIRCULAR_MACHINE_DETAILED_QUERY)
public class NetSmallCircularMachineDetailedQuery extends ReverseTradeMessage {

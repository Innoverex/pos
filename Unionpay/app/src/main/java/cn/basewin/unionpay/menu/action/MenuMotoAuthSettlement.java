 ...
 * 描述: 订购预授权完成通知 <br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_MOTO_AUTH_SETTLEMENT)
public class MenuMotoAuthSettlement extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_MOTO_AUTH_SETTLEMENT));
    }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(InputCardNumberAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_MOTO_AUTH_SETTLEMENT);
            }
        };
    }
}

 ...
 * 描述:  退货交易<br>
 */
@AnnotationNet(action = ActionConstant.ACTION_REFUND)
public class NetRefund extends ReverseTradeMessage {
    private static final String TAG = NetRefund.class.getName();

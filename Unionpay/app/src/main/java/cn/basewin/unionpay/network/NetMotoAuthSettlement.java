 ...
 * 订购预授权完成通知
 */
@AnnotationNet(action = ActionConstant.ACTION_MOTO_AUTH_SETTLEMENT)
public class NetMotoAuthSettlement extends ReverseTradeMessage {
    private static final String TAG = NetMotoAuthSettlement.class.getName();

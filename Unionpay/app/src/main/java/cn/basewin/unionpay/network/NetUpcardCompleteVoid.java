 ...
 * 描   述：手机芯片预授权完成撤销
 */
@AnnotationNet(action = ActionConstant.ACTION_UPCARD_COMPLETE_VOID)
public class NetUpcardCompleteVoid extends ReverseTradeMessage {
    private static final String TAG = NetUpcardCompleteVoid.class.getName();

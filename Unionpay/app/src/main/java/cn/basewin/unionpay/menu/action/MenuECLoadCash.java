 ...
 * 描述: 电子现金圈存（现金充值） <br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_ECLOAD_CASH)
public class MenuECLoadCash extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_ECLOAD_CASH));
    }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(SwipingCardAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_ECLOAD_CASH);
            }
        };
    }
}

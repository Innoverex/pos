 ...
 * 描述: 联盟积分退货 <br>
 */
@AnnotationNet(action = ActionConstant.ACTION_CUPBONUS_REFUND)
public class NetCUPBonusRefund extends ReverseTradeMessage {
    private String TAG = NetCUPBonusRefund.class.getName();
    ...
    protected Iso8583Manager getEncryption(Map<String, Object> map, Iso8583Manager iso) throws Exception {
        ...
        iso.setBit(60, "25" + batchAuto + "000" + "5" + "0" + "1" + "" + "065");

 ...
 * 描述: 撤销报文 <br>
 */
@AnnotationNet(action = ActionConstant.ACTION_UPCARD_VOID)
public class NetUpcardVoid extends ReverseTradeMessage {
    private static final String TAG = NetUpcardVoid.class.getName();

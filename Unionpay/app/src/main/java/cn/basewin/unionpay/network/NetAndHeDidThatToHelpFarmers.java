 ...
 * 他行助农取款
 */
@AnnotationNet(action = ActionConstant.ACTION_AND_HE_DID_THAT_TO_HELP_FARMERS)
public class NetAndHeDidThatToHelpFarmers extends ReverseTradeMessage {
    ...
    protected Iso8583Manager getEncryption(Map<String, Object> map, Iso8583Manager iso) throws Exception {
        ...
        iso.setBit(48, (String) FlowControl.MapHelper.getMap().get(InputIntoCardNumberAty.KEY_DATA));
        iso.setBit(49, "156");

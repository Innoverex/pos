 ...
 * 描述: 发卡行积分撤销 <br>
 */
@AnnotationNet(action = ActionConstant.ACTION_BONUS_VOID)
public class NetBonusVoid extends ReverseTradeMessage {
    private String TAG = NetBonusVoid.class.getName();
    ...
    protected Iso8583Manager getEncryption(Map<String, Object> map, Iso8583Manager iso) throws Exception {
        ...
        iso.setBit(60, "23" + SettingConstant.getBatch() + "000" + "5" + "0" + "1" + "" + "048");

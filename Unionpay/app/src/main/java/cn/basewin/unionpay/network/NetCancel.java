 ...
 * 描   述：预授权撤销报文
 */
@AnnotationNet(action = ActionConstant.ACTION_CANCEL)
public class NetCancel extends ReverseTradeMessage {
    private static final String TAG = NetCancel.class.getName();

 ...
 * 描述: 预授权完成(请求)<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_AUTH_COMPLETE)
public class MenuAuthComplete extends MenuAction {
    @Override
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(SwipingCardAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_AUTH_COMPLETE);
            }
        };
    }
}

 ...
 * 描   述：手机芯片预授权完成（请求）报文
 */
@AnnotationNet(action = ActionConstant.ACTION_UPCARD_AUTH_COMPLETE)
public class NetUpcardAuthComplete extends ReverseTradeMessage {
    private static final String TAG = NetUpcardAuthComplete.class.getName();

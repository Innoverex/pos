...
import cn.basewin.unionpay.trade.InputInstallNOAty;
 ...
 * 描述: 分期付款消费<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_INSTALLMENT)
public class MenuInstallment extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_INSTALLMENT));
    }

 ...
 * 描   述：电子现金脱机报文（插卡）
 */
@AnnotationNet(action = ActionConstant.ACTION_EC_SALE)
public class NetECSale extends OfflineTradeMessage {
    private static final String TAG = NetECSale.class.getName();

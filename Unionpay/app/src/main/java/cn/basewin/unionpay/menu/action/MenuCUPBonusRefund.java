 ...
 * 描述: 联盟积分退货<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_CUPBONUS_REFUND)
public class MenuCUPBonusRefund extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_CUPBONUS_REFUND));
    }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(InputManagerPWDAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_CUPBONUS_REFUND);
            }
        };
    }
}

 ...
 * 描   述：预授权完成（通知）报文
 */
@AnnotationNet(action = ActionConstant.ACTION_AUTH_SETTLEMENT)
public class NetAuthSettlement extends ReverseTradeMessage {
    private static final String TAG = NetAuthSettlement.class.getName();

 ...
 * 违章罚款缴费结果信息查询
 */
@AnnotationNet(action = ActionConstant.ACTION_VIOLATIONS_TO_EXPEND_THE_INFORMATION_QUERY)
public class NetViolationsToExpendTheInformationQuery extends ReverseTradeMessage {

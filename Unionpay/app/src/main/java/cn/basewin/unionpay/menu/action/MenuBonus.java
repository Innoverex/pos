 ...
 * 描述: 积分消费<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_BONUS)
public class MenuBonus extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_BONUS));
    }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(SwipingCardAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_BONUS);
            }
        };
    }
}

 ...
 * 描述: 积分消费撤销<br>
 */
@AnnotationMenu(action = ActionConstant.ACTION_BONUS_VOID)
public class MenuBonusVoid extends MenuAction {
    @Override
    public String getResName() {
        return TLog.getString(ActionConstant.getAction(ActionConstant.ACTION_BONUS_VOID));
    }
        ...
        return new Runnable() {
            ...
            public void run() {
                ...
                flowControl.begin(InputManagerPWDAty.class)
                        ...
                        .start(getContext(), ActionConstant.ACTION_BONUS_VOID);
            }
        };
    }
}

 ...
 * 实时代付确认接口
 */
@AnnotationNet(action = ActionConstant.ACTION_REAL_TIME_PAYMENT_CONFIRMATION_INTERFACE)
public class NetRealTimePaymentConfirmationInterface extends ReverseTradeMessage {

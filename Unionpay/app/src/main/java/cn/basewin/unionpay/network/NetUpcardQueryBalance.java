 ...
 * 描   述：手机芯片余额查询报文
 */
@AnnotationNet(action = ActionConstant.ACTION_UPCARD_QUERY_BALANCE)
public class NetUpcardQueryBalance extends TradeMessage {
    private static final String TAG = NetUpcardQueryBalance.class.getName();

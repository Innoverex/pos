 ...
 * 定期余额查询
 */
@AnnotationNet(action = ActionConstant.ACTION_BALANCE_INQUIRY_ON_A_REGULAR_BASIS)
public class NetBalanceInquiryOnARegularBasis extends ReverseTradeMessage {
